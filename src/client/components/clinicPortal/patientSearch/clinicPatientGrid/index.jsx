...
import { fetchPatientMasterData, fetchPatientExpandableData } from "../../../../clinicPortalServices/patientSearchService";
...
class ClinicPatientGrid extends Component {
      ...
      columnDefs: [
          ...
          field: 'gender'},
        {
          ...
          cellRenderer: function(params) {
            return '<span><i class="fas fa-envelope-square"></i> ' + params.data.email + '</span>'
       } 
        },
        {
          headerName: "Phone",
          ...
          minWidth: 150,
          cellRenderer: function(params) {
            return '<span><i class="fas fa-phone-square-alt"></i> ' + params.data.mobile + '</span>' 
       } 
        },
        {
          headerName: "Address",
          ...
          cellRenderer: function(params) {
            return '<span><i class="fas fa-map-marker-alt"></i> ' + params.value + '</span>'
       } 
        },
        { 
          headerName: "Source",
      ...
      detailCellRendererParams: {
        ...
        getDetailRowData: function (params) {
          fetchPatientExpandableData(
            params.data.patiendId
          ).then((expandableRowData) => {
  ...
  render() {
    return (
      <div>
        <div style={{ width: '100%', height: '550px', padding: '15px 15px 15px 15px'}}>
        <div
          id="myGrid"
          style={{
            height: '100%',
